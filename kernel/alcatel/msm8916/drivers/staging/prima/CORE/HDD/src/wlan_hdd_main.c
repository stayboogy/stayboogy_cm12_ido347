...
//JRD function.
/* FIXME:hard code.
 * filename: /tctpersist/data/param/macaddr
 * 	this file will be updated by tool [tctd] when boot-up.
...
#define MMCBLKP     "/dev/block/platform/bootdevice/by-name/traceability"
#define WLANFILE   "/tctpersist/data/param/macaddr"
...
static int jrd_get_mac_addr(unsigned char *eaddr)
{
	...
	mm_segment_t old_fs;
	//FIXME:hard code.
	strcpy(fn, "/tctpersist/data/param/macaddr");
